...
import { AiOutlineCopyright, AiFillInstagram } from "react-icons/ai";
    ...
    <div className="bg-[#252641] text-white">
      <div className="container flex flex-col gap-10 p-10">
        <div className="flex justify-center gap-4">
          ...
          <h3 className="text-xl">هگزا اسکواد</h3>
        </div>
        ...
        <div className="flex-col sm:flex-row flex justify-center items-center gap-5 sm:gap-2">
          <p className="px-11">دوره های آموزشی </p>
          <p className="sm:border-r-1 px-11">درباره ما</p>
        ...
        <div className="p-2 text-xs md:text-[1rem] flex-col md:flex-row flex justify-between bg-[#00000033] md:p-5 rounded-2xl gap-4">
          ...
          <div className="flex-wrap sm:flex-nowrap sm:flex-row flex gap-4 items-center justify-center">
            <SocialsIcon icon={<FaLinkedinIn />} />
            <SocialsIcon icon={<IoLogoWhatsapp />} />
            <SocialsIcon icon={<FaFacebookF />} />
            <SocialsIcon icon={<FaTwitter />} />
            <SocialsIcon icon={<AiFillInstagram />} />
          </div>
        </div>
      </div>
    </div>
